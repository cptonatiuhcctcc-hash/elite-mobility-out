...
const DEFAULT_SETTINGS={companyName:'Elite Mobility Rentas',logoUrl:'',rfc:'',address:'',phone:'',email:'',depositDefault:3000,fuelPolicy:'Tanque lleno / lleno',cancellationPolicy:'Cancelación sin costo 48h antes. Después: 1 día de renta.',terms:'Conductor mayor de 25 años, licencia vigente, identificación oficial.'};
...
const setBookings=a=>localStorage.setItem('renta.bookings',JSON.stringify(a));
